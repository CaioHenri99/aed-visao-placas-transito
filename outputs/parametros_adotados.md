...
Gerado automaticamente pelo notebook em 2026-09-22 15:31:18 (semente 42, OpenCV 5.0.0, Python 3.14.4).
...
| Suavização | gaussiano 3×3 | `impar(0.10 x 13.5) = 3` (mais estreito que a orla da placa menor) |
| Faixas de matiz | vermelho (H 9 +/- 6), amarelo (H 16 +/- 6) | Centro e largura medidos nas anotações da Seção 5.0, partindo das âncoras do CONTRAN |
| **Portas de saturação** | **vermelho 80, amarelo 100** | Estágio 0 da busca em grade, por descida em coordenadas |
| Faixas descartadas | azul | O estágio 0 mediu que elas custam mais em falso positivo do que rendem em detecção |
| **Kernel de abertura** | **3×3** | `impar(0.10 x 13.5) = 3` |
| **Kernel de fechamento** | **7×7** | `impar(0.25 x 27.1) = 7` |
...
| Limiar T de Otsu (diagnóstico) | recalculado por imagem: média 74.9, desvio 18.1, de 33.0 a 142.0 | Otsu restrito sobre o mapa de evidência, só como diagnóstico, não entra na segmentação. O desvio mostra o quanto a iluminação varia entre imagens. 0 imagem(ns) sem nenhum pixel com evidência de cor ficam fora da conta |
...
| **Área mínima de contorno** | **183 px²** | Descarta o quantil 0.30 inferior das placas anotadas (× 0,45 de preenchimento) |
| **Área máxima de contorno** | **6750 px²** | Descarta o quantil superior a 0.95: é um filtro de escala contra fachada e vegetação fotografadas de perto |
...
- Precisão 0.137 · Recall 0.157 · F1 0.146 (250 imagens)
- Erro absoluto médio de contagem: 0.92 objetos por imagem (chutar sempre 1 placa(s) dá 0.12)
- Contagem exata em 81 de 250 imagens